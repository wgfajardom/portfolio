...
if __name__ == '__main__':
    print('--------------------------------------------')   
    main_array_1, check_1 = load_board(get_input(1))
    print(main_array_1)
    print(main())
    print('--------------------------------------------')
    main_array_2, check_2 = load_board(get_input(2))
    print(main_array_2)
    print(main(2))
    print('--------------------------------------------')
    main_array_3, check_3 = load_board(get_input(3))
    print(main_array_3)
    print(main(3))
    print('--------------------------------------------')